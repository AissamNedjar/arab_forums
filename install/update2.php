...
$sql_option  =  @mysql_query("select option_var , option_val from ".$connect["prefix"]."option");

while($array_option  =  @mysql_fetch_assoc($sql_option)){

define($array_option["option_var"] , $array_option["option_val"]);

}

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"dateforum\" , \"".time()."\"");

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"title\" , \"".forum_name."\"");

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"adress\" , \"".forum_adress."\"");

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"showurl\" , \"".forum_adress."\"");

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"keywords\" , \"".forum_keywords."\"");

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"description\" , \"".forum_description."\"");

insert_mysql("arab-forums" , "option" , "option_id , option_name , option_value" , "null , \"emailbiot\" , \"admin@admin.com\"");
...
echo "<form action=\"install.php?go=updatec0lddz&type=updatetable1\" method=\"post\">";
