...
if($array[medal_forum] == "-1"){$array[medal_forum] = "0";}else{$array[medal_forum] = $array[medal_forum];}

if($array[medal_lock] == "1"){$array[medal_lock] = "1";}elseif($array[medal_lock] == "2"){$array[medal_lock] = "3";}else{$array[medal_lock] = "0";}
...
if($array[getmedal_lock] == "1"){$array[getmedal_lock] = "1";}elseif($array[getmedal_lock] == "2"){$array[getmedal_lock] = "3";}else{$array[getmedal_lock] = "0";}
