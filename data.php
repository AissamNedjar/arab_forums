...
for($x = 1; $x <= 31 ; $x++){echo "<option value=\"{$x}\" ".($user_object->user_days == $x ? "selected" : "").">{$x}</option>";}

echo "</select>&nbsp;<select class=\"inputselect\" name=\"month\">";

for($x = 1; $x <= 12 ; $x++){echo "<option value=\"{$x}\" ".($user_object->user_month == $x ? "selected" : "").">{$months_list[$x]}</option>";}

echo "</select>&nbsp;<select class=\"inputselect\" name=\"years\">";

for($x = 1904; $x <= 2012 ; $x++){echo "<option value=\"{$x}\" ".($user_object->user_years == $x ? "selected" : "").">{$x}</option>";}
