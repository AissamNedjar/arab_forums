...
if(get_cookie("arab-forums" , "refererkj") != ""){$referer = get_cookie("arab-forums" , "refererkj");}else{$referer = referer;}
...
if(get_cookie("arab-forums" , "refererm") != ""){$referer = get_cookie("arab-forums" , "refererm");}else{$referer = referer;}
...
if($forummm == 5){echo "</tr><tr>";$forummm = 0;}
