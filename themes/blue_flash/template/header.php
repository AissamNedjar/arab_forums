...
$template .= "<div style=\"background-image:url('themes/".forum_style."/images/bgbg.gif');\" width=\"100%\" border=\"0\"><embed src=\"themes/".forum_style."/logo.swf\" quality=\"high\" width=\"800\" height=\"115\"></div>";

$template .= "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\"><tr><td>";

$template .= "<ul class=\"head\">";

$template .= "<li ".(pagebody == "home" ? "class=\"current\"" : "").">".a_other("arab-forums" , "home.php" , "الرئيسية" , "<b>الرئيسية</b>" , "")."</li>";

$template .= "<li ".(pagebody == "members" || pagebody == "online" ? "class=\"current\"" : "").">".a_other("arab-forums" , "members.php" , "الأعضاء" , "الأعضاء" , "")."</li>";

if(group_user > 0){

$template .= "<li ".(pagebody == "mtopic" ? "class=\"current\"" : "").">".a_other("arab-forums" , "mtopic.php" , "مواضيعك" , "<b>مواضيعك</b>" , "")."</li>";

$template .= "<li ".(pagebody == "mposts" ? "class=\"current\"" : "").">".a_other("arab-forums" , "mposts.php" , "مشاركاتك" , "<b>مشاركاتك</b>" , "")."</li>";

$template .= "<li ".(pagebody == "monitor" ? "class=\"current\"" : "").">".a_other("arab-forums" , "monitor.php" , "المفضلة" , "<b>المفضلة</b>" , "")."</li>";

$template .= "<li ".(pagebody == "message" && admin == "" && msgu == "" && msgf == "" ? "class=\"current\"" : "").">".a_other("arab-forums" , "message.php" , "الرسائل" , "<b>الرسائل</b>" , "")."</li>";

}

$template .= "<li ".(pagebody == "active" ? "class=\"current\"" : "").">".a_other("arab-forums" , "active.php" , "مواضيع نشطة" , "<b>مواضيع نشطة</b>" , "")."</li>";

$template .= "<li ".(pagebody == "search" ? "class=\"current\"" : "").">".a_other("arab-forums" , "search.php" , "إبحث" , "<b>إبحث</b>" , "")."</li>";

if(helpforum_option != 0){

$template .= "<li ".(pagebody == "forum" && id == helpforum_option ? "class=\"current\"" : "").">".a_other("arab-forums" , "forum.php?id=".helpforum_option."" , "مساعدة" , "<b>مساعدة</b>" , "")."</li>";

}

if(group_user > 0){

$template .= "<li ".(pagebody == "data" ? "class=\"current\"" : "").">".a_other("arab-forums" , "data.php" , "بيانتك" , "<b>بيانتك</b>" , "")."</li>";

}

if(group_user == 0){

$template .= "<li ".(pagebody == "register" ? "class=\"current\"" : "").">".a_other("arab-forums" , "register.php" , "التسجيل" , "<b>التسجيل</b>" , "")."</li>";

}else{

$template .= "<li ".(pagebody == "logout" ? "class=\"current\"" : "").">".a_other("arab-forums" , "logout.php?go=".(md5(id_user*51285858585455*sqlcode_connect))."" , "خروج !" , "<b>خروج !</b>" , confirm_other("arab-forums" , "هل أنت متأكد من أنك تريد تسجيل الخروج ؟"))."</li>";

}

$template .= "</ul></td></tr></table><br><br>";
...
$template .= "</tr></table></center><br><br>";

if(group_user == 0){

$template .= "<center>";

$template .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tbody><tr><td align=\"center\"><div class=\"stat_register\" align=\"center\"><nobr><font color=\"black\" size=\"5\">وضعية التسجيل: ";

if( registeroff_option == 0){

$template .= "<font color=\"green\">مفتوح</font>";

}else{

$template .= "<font color=\"red\">مغلوق</font>";

}

$template .= "</font></nobr></div></td></tr></tbody></table>";
