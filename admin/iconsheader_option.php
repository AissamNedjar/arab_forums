...
if($iconsheader_object->iconsheader_lock == 1){$error = false;$text = "الأيقونة معطلة من قبل";$class = "error";}else{$error = true;$text = "تم تعطيل الأيقونة بنجاح تام";$class = "good";}

if($error == true){update_mysql("arab-forums" , "iconsheader" , "iconsheader_lock = \"1\" where iconsheader_id = \"{$iconsheader_object->iconsheader_id}\"");}
...
if($iconsheader_object->iconsheader_lock == 0){$error = false;$text = "الأيقونة مفعلة من قبل";$class = "error";}else{$error = true;$text = "تم تفعيل الأيقونة بنجاح تام";$class = "good";}

if($error == true){update_mysql("arab-forums" , "iconsheader" , "iconsheader_lock = \"0\" where iconsheader_id = \"{$iconsheader_object->iconsheader_id}\"");}
